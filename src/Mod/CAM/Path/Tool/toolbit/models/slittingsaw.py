...
class ToolBitSlittingSaw(ToolBit, CuttingToolMixin, RotaryToolBitMixin):
    ...
    def __init__(
        self, shape: ToolBitShapeSlittingSaw, id: str | None = None, attrs: Optional[Mapping] = None
    ):
        logger.track(f"ToolBitSlittingSaw __init__ called with shape: {shape}, id: {id}")
